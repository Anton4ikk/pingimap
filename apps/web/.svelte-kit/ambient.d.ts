...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies__pingimap_config: string;
	export const npm_package_devDependencies__pingimap_tsconfig: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		XPC_FLAGS: string;
		npm_package_devDependencies__pingimap_config: string;
		npm_package_devDependencies__pingimap_tsconfig: string;
